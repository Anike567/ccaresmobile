...
const OptionButtonView = (props) => 
{
    ...
    const PFOpeningBalanceHandler = () => {
        ...
        props.seth((prevC) => [...prevC, {'handler':'pfopeningbalancetexthandler', 'time':displayQueryData, 'type':'plaintext','message':'PF Opening Balance','entity':'human'}])
        props.seth((prevC) => [...prevC, {'handler':'pfopeningbalancetexthandler', 'time':displayQueryData, 'type':'plaintext','message':'Enter year','entity':'agent'}])
...
const Koylamitrascreen = ({navigation}) => {
    ...
    const PFOpeningBalanceTextHandler = () => {
        ...
        // {'handler':'pfopeningbalancehandler','time':displayQueryData, 'type':'option','message':'Opening Balance','entity':null},
        // {'handler':'pfopeningbalancehandler','time':displayQueryData, 'type':'option','message':'Closing Balance','entity':null},
        // {'handler':'pfopeningbalancehandler','time':displayQueryData, 'type':'option','message':'Rate Of Interest','entity':null}
    )
