            ...
            <FlatList
                ...
                renderItem={({ item, index }) => (
                    <View style={styles.itemContainer}>
                        {item.type === "plaintext" && <PlainTextView message={item.message} time={item.time} entity={item.entity} />}
                        {item.type === "option" && <OptionButtonView
                            ...
                            entity={item.entity}
                        />}
                        {item.type === "selectedoption" && <SelectedOption
                            message={item.message}
                            disabled={item.disabled}
                            selected={item.selected}
                            index={index}
