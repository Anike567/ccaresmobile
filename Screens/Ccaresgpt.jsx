...
const Ccaresgptscreen = ({navigation}) => {
    ...
    const [chatHistory, setChatHistory] = useState([{time:displayData, role:'model','message':'Hi, \nI am CCARES-Assist.\nYou can ask me anything related to your personal and employment data.\nYou can also ask me about CMPFO.'}]);
...
export default Ccaresgptscreen;